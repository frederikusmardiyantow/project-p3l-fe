...
const Dashboard = () => {
  ...
  return (
    <div className={`sidebar ${isSidebarOpen ? '' : 'hidden'} fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900`}>
      <div className="text-gray-100 text-xl">
        <div className="p-2.5 mt-1 flex items-center">
          <i className="bi bi-app-indicator px-2 py-1 rounded-md bg-blue-600"></i>
          <h1 className="font-bold text-gray-200 text-[15px] ml-3">TailwindCSS</h1>
          <i className={`bi bi-x cursor-pointer ml-28 ${isSidebarOpen ? '' : 'lg:hidden'}`} onClick={toggleSidebar}></i>
        </div>
      ...
      <div className={`text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold ${isSubmenuHidden ? 'hidden' : ''}`} id="submenu">
